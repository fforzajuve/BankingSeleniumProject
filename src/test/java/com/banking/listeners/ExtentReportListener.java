...
public class ExtentReportListener extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext)
	{
		...
		htmlReporter.config().setReportName("E-Banking Testing Report"); // name of the report
	...
	public void onTestFailure(ITestResult tr)
	{
		...
		try {
			test.addScreenCaptureFromPath(takeScreenshot(tr.getName(), DriverManager.getDriver().getDriver()),  tr.getName());
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
