...
public class DepositInputPage extends BasePage {
	...
	public DepositInputPage(DriverUtils driver) {
		super(driver);
	}
	
	public DepositPage putDepositToAccount(int accountId, double amount, String desc) {
